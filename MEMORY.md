...
## 🔴 v4.0 — Новая концепция: Lineage-память (2026-07-21)

> Полная смена парадигмы. Odf2-KO (9 рецензий) отброшен. Новая гипотеза: центриоль как материальный носитель пространственной lineage-памяти.

### Ключевая идея

Пространственная spindle orientation pedigree центриоли в дереве делений (последовательность ориентаций каждого митоза) предсказывает судьбу клетки.

### Главный эксперимент: Конвергенция

4 центриоли одного возраста, разные spindle orientation pedigree. Если A=C≠B=D по структуре и судьбе — возраст не объясняет. Spindle orientation pedigreeия доказана.

### Две фазы
- **Фаза 1:** C. elegans — визуализация принципа
- **Фаза 2:** RPE1 на ARGUS-OS1 — тест центриоли как носителя

### Результаты 9 рецензий (Odf2-KO)
- SAI неспецифичен для СДА
- N=110 underpowered
- Δ4/5 не валидирован в RPE1
- Логический разрыв: цилии сохранены → SAI не интерпретируем
- **Решение:** отказаться от Odf2-KO. Перейти к информационному подходу.
