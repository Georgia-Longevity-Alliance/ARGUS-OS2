...
Пространственная centriole pedigree центриоли в дереве делений (последовательность ориентаций каждого митоза) предсказывает судьбу клетки.

### Главный эксперимент: Конвергенция

4 центриоли одного возраста, разные centriole pedigree. Если A=C≠B=D по структуре и судьбе — возраст не объясняет. Centriole pedigreeия доказана.
