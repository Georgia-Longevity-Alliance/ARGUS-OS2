...
ARGUS-OS2 проверяет гипотезу: **центриоль — физический носитель записи пространственной centriole pedigree делений.**
...
**Следствие для прогениторных карт:** карта — граф с конвергенциями. **Узлы = генетические сети** (паттерны экспрессии). Одна судьба достижима разными centriole pedigreeми. OS3 добавляет генетические сети к centriole pedigreeм.
